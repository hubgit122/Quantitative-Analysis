  ...
  public static class BiExpression extends Expression implements Serializable {
    ...
    public boolean equals(Object obj) {
      if (obj == null || !(obj instanceof Val)) {
        ...
        return operator.equals(that.operator) && lExpression.equals(that.lExpression)
            && lExpression.equals(that.rExpression);
      }
    }
  }
    ...
    public String toString() {
      if (isFloat) {
        ...
        sb.append('(').append(StringUtils.join(",", args)).append(')')
            .append(type != ValueType.closing ? '.' + type.toString() : "").append(rest ? "" : "..norest");
