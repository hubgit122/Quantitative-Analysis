...
public class ReflectTreeBuilder extends ReflectSemantic
{
    ...
    {
        BiRuleExpression result = new BiRuleExpression();
        result.lrule = (RuleExpression) ruleExpr;
        result.rrule = (RuleExpression) ruleTerm;
    ...
    {
        BiRuleExpression result = new BiRuleExpression();
        result.lrule = (RuleExpression) ruleTerm;
        result.rrule = (RuleExpression) ruleFactor;
        result.op = BinaryRuleOperator.AND;

        return result;
    }
    
    public Object ruleFactor(Object lexpr, Object inequOrRuleExpr, Object rexpr, Object opt_back) throws Exception
    {
        if (lexpr.equals("("))
        {
    ...
    public static class RuleExpression extends Node implements Serializable
    {
    }

    public static class BiRuleExpression extends RuleExpression implements Serializable
    {
        public RuleExpression     lrule, rrule;
        public BinaryRuleOperator op;

        @Override
        public String toString()
        {
            return lrule.toString() + op.toString() + rrule.toString();
        }
    }

    public static class RuleVal extends RuleExpression implements Serializable
    {
        ...
        public String toString()
        {
            return lexpr.toString() + inequality.toString() + rexpr.toString();
        }
    }
