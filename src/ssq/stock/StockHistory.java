...
public class StockHistory extends ArrayList<DateData>
{
    ...
    public float func(String method, List<Float> args, ValueType type, boolean rest)
    {
        ...
        switch (method)
        {
            ...
            // case "mean":
            // return mean(args.get(0).intValue() + args.get(2).intValue(),
            // args.get(1).intValue() + args.get(2).intValue(), type, rest);
    ...
    // private float mean(int firstDay, int lastDay, ValueType type, boolean
    // rest)
    // {
    // return -1;
    // }
